// (i) WARNING: DO NOT EDIT THIS FILE.
...
// -----------------------------------------
// (i) ВНИМАНИЕ: НЕ РЕДАКТИРУЙТЕ ЭТОТ ФАЙЛ.
// Этот файл автоматически создается приложением индексатора масштабирования
// и будет обновляться каждый раз при повторной индексации вашего сайта. Вы должны сделать все
// настройка изменяется непосредственно из индексатора, через окно конфигурации.

// Если вы хотите изменить текстовые сообщения, такие как "Результаты поиска для...",
// и т.д., Затем найдите "Увеличить языковые файлы" или "Перевод страницы поиска"
